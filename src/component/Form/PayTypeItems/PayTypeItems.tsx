...
import { changeChoicePayType, setStep } from '../../../action/onlinePay';
    ...
    <>
      {
        payTypes.map(payType => (
          ...
          >
            <div
              className={
                clsx(`${classes.payTypeItem} ${selectPayType === payType.id ? classes.activePayTypeItem : ''} `)
              }
              onClick={() => {setSelectPayType(payType.id)}}
            >
              {selectPayType !== payType.id ?
                <>
                  <svg
                  ...
                  <svg
                    className={clsx(classes.payTypeIcon)}
                    viewBox="0 0 24 24"
                  >
                    <path fill="#FFFFFF" d={payType.svgPath} />
                  </svg>
